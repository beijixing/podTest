...
//    _scrollView.frame = self.bounds;
    _hornImageView.frame = CGRectMake(0, 2, self.frame.size.height-4, self.frame.size.height-4);
    ...
    _messageTypeLabel.frame = CGRectMake(15, 0, size.width, self.frame.size.height);
    _contentTextView.frame = CGRectMake(CGRectGetMaxX(_messageTypeLabel.frame)+5, offsetY, self.frame.size.width-CGRectGetMaxX(_messageTypeLabel.frame)-10, self.frame.size.height-2*offsetY);
